...
<head>
    ...
    <link rel="icon" type="{{asset('frontend/assets/image/png')}}" href="images/favicon.png">
...
<body>
    ...
    <script src="{{('frontend/assets/js/jquery.countup.min.js')}}"></script>
    <!--add row js-->
    <script src="{{('frontend/assets/js/add_row_custon.js')}}"></script>
    <!--multiple-image-video js-->
    <script src="{{('frontend/assets/js/multiple-image-video.js')}}"></script>
    <!--sticky sidebar js-->
    <script src="{{('frontend/assets/js/sticky_sidebar.js')}}"></script>
    <!--price ranger js-->
